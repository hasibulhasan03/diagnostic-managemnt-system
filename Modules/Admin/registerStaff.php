<?php
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $uploadIMG = '../Uploaded/Staff/'.$image;
        $staffType = $_POST["staffType"];

            $query = "INSERT INTO staff (firstName, lastName, email, phone, dateOfBirth, gender, image, staffType) VALUES ('$firstName', '$lastName', '$email', '$phone', '$dateOfBirth', '$gender', '$image', '$staffType')";
            ...
            <form action="" class = "register" method="post" enctype="multipart/form-data">
                ...
                <div class="register-input-row">
                    <div class="register-input-group">
                        ...
                        <select name="staffType" id="gender" required>
